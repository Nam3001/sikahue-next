    ...
    <footer className="bg-gray-900 text-white pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/gioi-thieu" className="flex items-center space-x-2 text-gray-400 hover:text-white transition-colors">
                  <Info size={16} />
              ...
              <li>
                <Link href="/bang-gia" className="flex items-center space-x-2 text-gray-400 hover:text-white transition-colors">
                  <List size={16} />
                  <span>Bảng Giá</span>
                </Link>
              </li>
              <li>
                <Link href="/tin-tuc" className="flex items-center space-x-2 text-gray-400 hover:text-white transition-colors">
                  <List size={16} />
                  <span>Tin Tức</span>
                </Link>
              </li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-6 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Sika Vietnam. Tất cả quyền được bảo lưu.</p>
        </div>
      </div>
    </footer>
  );
